...
class WGPU {
  ...
  WGPU(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  late final _wgpuDevicePollPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(WGPUDevice, ffi.Bool)>>(
          'wgpuDevicePoll');
  late final _wgpuDevicePoll =
      _wgpuDevicePollPtr.asFunction<void Function(WGPUDevice, bool)>();
